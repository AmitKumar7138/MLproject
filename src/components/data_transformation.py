...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            logging.info(
                f"Numerical columns standard scaling completed.\n Numerical columns:{numerical_columns}")
            logging.info(
                f"Categorical columns encoding completed.\n Catgorical_columns:{categorical_columns}")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Obtained preprocssing object")
